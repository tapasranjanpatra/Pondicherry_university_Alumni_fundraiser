                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4 col-md-4 pull-right">
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" name="card_cvc" placeholder="CVC" autocomplete="cc-csc" id="card_cvc" maxlength="3" required />
                                        </div>
                                    </div>
                                </div>
   
   
    <button type="submit" id="payBtn" class="btn btn-primary">PAY ₹ 200</button>
  </form>
</div>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.4/jquery.min.js"></script>
 ...
 <script>
        ...
        Stripe.setPublishableKey('pk_test_51ORXf3ECpsjojMDBjN5dUueGrKY6lA425U5fMfuBLlNfPPDsZg4qpYlbhRd163mQKyJKizSxWEqcE2FIZJXcGUJw00ulM7oiQU');
